    ...
    return (
      ...
      <nav className="bg-gray-50 border-b-2 border-gray-200 px-2 sm:px-4 py-2 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
        <div className="flex flex-wrap justify-between items-center mx-auto">
          ...
          <div className={`${hidden ? 'hidden' : " "} justify-between items-center w-full md:flex md:w-auto md:order-1`}> 
           <ul onClick={()=>sethidden(!hidden)} className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li >
                <Link 
                 activeClass="active"
                 spy={true}
                 ...
                 offset={-70}
                 duration={1000}
                 to="Home" onClick={()=>setActiveNav("Home")} className={ActiveNav === "Home" ? Activeclass : inActiveclass} end>Home</Link>
              </li>
              <li >
                <Link  
                activeClass="active"
                ...
                smooth={true}
                offset={-70}
                duration={1000} to="Projects" onClick={()=>setActiveNav("Projects")} className={ ActiveNav === "Projects"  ? Activeclass : inActiveclass}>Projects</Link>
              </li>
              <li>
                ...
                duration={1000}
                to="About"
                onClick={()=>setActiveNav("About")} className={ActiveNav === "About" ? Activeclass : inActiveclass}>About Me</Link>
              </li>
              <li>
                <Link  activeClass="active"
                spy={true}
                ...
                offset={-20}
                duration={1000}
                to="Contact" onClick={()=>setActiveNav("Contact")} className={ActiveNav === "Contact" ? Activeclass : inActiveclass} >Contact ME</Link>
              </li>
            </ul>
          </div>
        </div>
